...
_AI_WATCH_COMPANIES = {
    "foundation": [
        {"name": "OpenAI",             "tagline": "GPT-4, ChatGPT, Sora — the company that kicked off the AI era",   "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Anthropic",          "tagline": "Claude models — safety-first AI lab founded by ex-OpenAI team",   "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Google DeepMind",    "tagline": "Gemini, AlphaFold, AlphaGo — Google's combined AI research lab", "country": "🇬🇧", "cc": "GB", "stage": "Corporate",  "new": False},
        {"name": "Mistral AI",         "tagline": "Europe's leading open-weight model lab — fast and efficient",     "country": "🇫🇷", "cc": "EU", "stage": "Scale-up",   "new": True},
        {"name": "Cohere",             "tagline": "Enterprise LLM APIs — RAG, embeddings, Command R",                "country": "🇨🇦", "cc": "OTHER", "stage": "Scale-up", "new": False},
        {"name": "xAI",                "tagline": "Musk's AI lab — Grok models, built on X/Twitter data",           "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": True},
        {"name": "Hugging Face",       "tagline": "The GitHub of ML — open-source models, datasets, spaces",        "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Stability AI",       "tagline": "Stable Diffusion — pioneering open-source image generation",     "country": "🇬🇧", "cc": "GB", "stage": "Scale-up",   "new": False},
        {"name": "Together AI",        "tagline": "Fast inference cloud for open-source models",                     "country": "🇺🇸", "cc": "US", "stage": "Startup",    "new": True},
        {"name": "Perplexity AI",      "tagline": "AI-native search engine — answers with sources",                 "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": True},
    ],
    "healthcare": [
        {"name": "Neko Health",        "tagline": "Full-body preventive health scans powered by AI",                "country": "🇸🇪", "cc": "EU", "stage": "Scale-up",   "new": True},
        {"name": "Suki AI",            "tagline": "Voice assistant for clinical documentation",                      "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Viz.ai",             "tagline": "AI-powered stroke and cardiac care coordination",                 "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "BenevolentAI",       "tagline": "Drug discovery and development platform",                        "country": "🇬🇧", "cc": "GB", "stage": "Listed",     "new": False},
        {"name": "Recursion",          "tagline": "Drug discovery at machine scale",                                "country": "🇺🇸", "cc": "US", "stage": "Listed",     "new": False},
        {"name": "Tempus AI",          "tagline": "AI data platform for precision oncology",                        "country": "🇺🇸", "cc": "US", "stage": "Listed",     "new": True},
        {"name": "Nabla",              "tagline": "AI ambient scribe for doctors — automatic clinical notes",        "country": "🇫🇷", "cc": "EU", "stage": "Scale-up",   "new": True},
        {"name": "Paige.AI",           "tagline": "AI pathology — FDA-cleared cancer detection",                    "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Waymark",            "tagline": "AI for community health workers — Medicaid focus",               "country": "🇺🇸", "cc": "US", "stage": "Startup",    "new": True},
        {"name": "Insilico Medicine",  "tagline": "AI drug design — first AI-discovered drug in clinical trials",   "country": "🇭🇰", "cc": "OTHER", "stage": "Scale-up", "new": False},
    ],
    "fintech": [
        {"name": "Ramp",               "tagline": "AI-powered corporate cards and expense management",              "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Sardine",            "tagline": "AI fraud prevention for fintech and crypto",                     "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Cleo",               "tagline": "AI money coach — Gen Z banking alternative",                     "country": "🇬🇧", "cc": "GB", "stage": "Scale-up",   "new": False},
        {"name": "Quantexa",           "tagline": "AI for financial crime and customer intelligence",               "country": "🇬🇧", "cc": "GB", "stage": "Scale-up",   "new": True},
        {"name": "Feedzai",            "tagline": "Real-time AI fraud detection at banking scale",                  "country": "🇵🇹", "cc": "EU", "stage": "Scale-up",   "new": False},
        {"name": "Alloy",              "tagline": "Identity decisioning platform for banks and fintechs",           "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": True},
        {"name": "Hyperplane",         "tagline": "Banking AI personalisation at scale",                           "country": "🇺🇸", "cc": "US", "stage": "Startup",    "new": False},
        {"name": "Zest AI",            "tagline": "AI credit underwriting for inclusive lending",                   "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Taktile",            "tagline": "Decision automation for fintech risk teams",                     "country": "🇩🇪", "cc": "EU", "stage": "Startup",    "new": False},
        {"name": "Monzo",              "tagline": "UK digital bank using AI for fraud and customer service",        "country": "🇬🇧", "cc": "GB", "stage": "Scale-up",   "new": False},
    ],
    "legal": [
        {"name": "Harvey",             "tagline": "AI for law firms — backed by OpenAI",                           "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": True},
        {"name": "Luminance",          "tagline": "AI contract analysis and due diligence",                        "country": "🇬🇧", "cc": "GB", "stage": "Scale-up",   "new": False},
        {"name": "Robin AI",           "tagline": "AI contract review for legal teams",                            "country": "🇬🇧", "cc": "GB", "stage": "Startup",    "new": False},
        {"name": "Ironclad",           "tagline": "Digital contracting platform — contract lifecycle AI",           "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": True},
        {"name": "Clio",               "tagline": "Cloud legal practice management with AI workflows",              "country": "🇨🇦", "cc": "OTHER", "stage": "Scale-up", "new": False},
        {"name": "Juro",               "tagline": "AI-native contract platform for in-house teams",                "country": "🇬🇧", "cc": "GB", "stage": "Startup",    "new": True},
        {"name": "Spellbook",          "tagline": "AI contract drafting inside Microsoft Word",                    "country": "🇨🇦", "cc": "OTHER", "stage": "Startup",  "new": False},
        {"name": "Legl",               "tagline": "Client onboarding and compliance AI for UK law firms",          "country": "🇬🇧", "cc": "GB", "stage": "Startup",    "new": True},
    ],
    "climate": [
        {"name": "Cervest",            "tagline": "Climate intelligence platform for physical risk",                "country": "🇬🇧", "cc": "GB", "stage": "Scale-up",   "new": False},
        {"name": "Pachama",            "tagline": "AI carbon credit verification via satellite",                   "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Watershed",          "tagline": "Enterprise carbon management and reporting",                    "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Tomorrow.io",        "tagline": "Weather and climate intelligence API",                          "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Sylvera",            "tagline": "Carbon market ratings and analytics",                          "country": "🇬🇧", "cc": "GB", "stage": "Startup",    "new": False},
        {"name": "South Pole",         "tagline": "Global climate solutions — carbon project developer",           "country": "🇨🇭", "cc": "EU", "stage": "Scale-up",   "new": True},
        {"name": "Rubicon Carbon",     "tagline": "Technology platform for high-quality carbon markets",          "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": True},
        {"name": "Climeworks",         "tagline": "Direct air capture — removing CO₂ from atmosphere at scale",   "country": "🇨🇭", "cc": "EU", "stage": "Scale-up",   "new": False},
    ],
    "edtech": [
        {"name": "Khanmigo",           "tagline": "Khan Academy's AI tutor — Socratic, not answer-giving",        "country": "🇺🇸", "cc": "US", "stage": "Non-profit", "new": False},
        {"name": "Synthesis",          "tagline": "AI-powered learning for kids — born at SpaceX",               "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Sana Labs",          "tagline": "AI learning platform for enterprise teams",                    "country": "🇸🇪", "cc": "EU", "stage": "Scale-up",   "new": False},
        {"name": "Duolingo",           "tagline": "World's largest language learning app — AI-powered personalisation", "country": "🇺🇸", "cc": "US", "stage": "Listed", "new": False},
        {"name": "Coursera",           "tagline": "Online courses with AI-assisted learning paths",               "country": "🇺🇸", "cc": "US", "stage": "Listed",     "new": False},
        {"name": "Cognii",             "tagline": "AI writing assessment and virtual tutoring",                   "country": "🇺🇸", "cc": "US", "stage": "Startup",    "new": False},
        {"name": "Ello",               "tagline": "AI reading companion for children",                           "country": "🇺🇸", "cc": "US", "stage": "Startup",    "new": False},
        {"name": "Multiverse",         "tagline": "AI-powered apprenticeships replacing traditional degrees",     "country": "🇬🇧", "cc": "GB", "stage": "Scale-up",   "new": True},
    ],
    "retail": [
        {"name": "Ocado Technology",   "tagline": "AI warehouse robotics and grocery fulfilment platform",        "country": "🇬🇧", "cc": "GB", "stage": "Listed",     "new": False},
        {"name": "Bloomreach",         "tagline": "AI personalisation and search for e-commerce",                 "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Signifyd",           "tagline": "AI fraud protection and chargeback insurance for retailers",   "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Constructor.io",     "tagline": "AI-powered product discovery — search and recommendations",    "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": True},
        {"name": "Syte",               "tagline": "Visual AI for fashion — camera search and styling",            "country": "🇮🇱", "cc": "OTHER", "stage": "Scale-up", "new": False},
        {"name": "Focal Systems",      "tagline": "AI shelf analytics — detecting out-of-stocks in real time",   "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": True},
        {"name": "Celonis",            "tagline": "Process mining AI — finding operational waste at enterprise scale", "country": "🇩🇪", "cc": "EU", "stage": "Scale-up", "new": False},
        {"name": "Trigo",              "tagline": "AI checkout-free store technology for supermarkets",           "country": "🇮🇱", "cc": "OTHER", "stage": "Scale-up", "new": True},
    ],
    "hr": [
        {"name": "Beamery",            "tagline": "AI talent intelligence — skills-based hiring and retention",   "country": "🇬🇧", "cc": "GB", "stage": "Scale-up",   "new": False},
        {"name": "Eightfold AI",       "tagline": "AI talent platform — matching people to roles they can grow into", "country": "🇺🇸", "cc": "US", "stage": "Scale-up", "new": False},
        {"name": "HireVue",            "tagline": "AI video interview and assessments for high-volume hiring",    "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Paradox",            "tagline": "Olivia — AI recruiting assistant that handles scheduling",     "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": True},
        {"name": "Textio",             "tagline": "AI writing for inclusive job posts and performance reviews",   "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Phenom",             "tagline": "AI talent experience platform — career sites and CRM",        "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Leapsome",           "tagline": "AI people enablement — performance, learning, engagement",    "country": "🇩🇪", "cc": "EU", "stage": "Scale-up",   "new": True},
        {"name": "Bryq",               "tagline": "Talent intelligence using cognitive and personality science",  "country": "🇬🇷", "cc": "EU", "stage": "Startup",    "new": True},
    ],
    "security": [
        {"name": "Darktrace",          "tagline": "Autonomous AI cyber defence — self-learning threat detection", "country": "🇬🇧", "cc": "GB", "stage": "Listed",     "new": False},
        {"name": "SentinelOne",        "tagline": "AI endpoint security — real-time threat prevention",          "country": "🇺🇸", "cc": "US", "stage": "Listed",     "new": False},
        {"name": "Abnormal Security",  "tagline": "AI email security — stops social engineering and BEC",        "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Vectra AI",          "tagline": "AI-powered network detection and response",                   "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Cybereason",         "tagline": "AI-driven endpoint and XDR security platform",               "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Orca Security",      "tagline": "AI cloud security — agentless workload and data protection",  "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": True},
        {"name": "Snyk",               "tagline": "Developer-first AI security — finds vulns in code and deps",  "country": "🇬🇧", "cc": "GB", "stage": "Scale-up",   "new": False},
        {"name": "Exabeam",            "tagline": "AI SIEM — behavioural analytics for threat detection",        "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
    ],
    "creative": [
        {"name": "Midjourney",         "tagline": "The leading AI image generation model — photorealistic and artistic", "country": "🇺🇸", "cc": "US", "stage": "Startup",  "new": False},
        {"name": "ElevenLabs",         "tagline": "AI voice — cloning, dubbing, and text-to-speech at scale",   "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Runway",             "tagline": "AI video generation and creative tools — Gen-2 and beyond",   "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Synthesia",          "tagline": "AI video with digital avatars — enterprise L&D and comms",   "country": "🇬🇧", "cc": "GB", "stage": "Scale-up",   "new": False},
        {"name": "HeyGen",             "tagline": "AI video translation and personalised spokesperson videos",   "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": True},
        {"name": "Descript",           "tagline": "AI podcast and video editor — edit audio by editing text",   "country": "🇺🇸", "cc": "US", "stage": "Scale-up",   "new": False},
        {"name": "Pika Labs",          "tagline": "AI video generation — fast, accessible, consumer-focused",   "country": "🇺🇸", "cc": "US", "stage": "Startup",    "new": True},
        {"name": "Ideogram",           "tagline": "AI image generation with accurate text rendering",            "country": "🇨🇦", "cc": "OTHER", "stage": "Startup",  "new": True},
    ],
}
