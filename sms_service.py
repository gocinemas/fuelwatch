...
def api_intel_pins():
    ...
    # Normalise phone to plain +44... format
    if phone:
        phone = phone.replace("whatsapp:", "").strip()
    identity = phone or did  # phone takes priority — syncs across devices
    try:
        sb = lib._sb()
        ...
        for row in rows:
            ...
            if identity and identity not in pinned_by:
                if not d.get("_pinned"):
                    continue
            elif not identity and not (d.get("_pinned") or pinned_by):
                continue
            key = row.get("key", "")
            name = d.get("name") or ""
            if not name:
...
def api_intel_pin():
    ...
    phone = (body.get("phone") or "").strip().replace("whatsapp:", "")
    identity = phone or did  # phone syncs across devices
...
def api_intel_unpin():
    ...
    try:
        ...
        if rows:
            data = dict(rows[0]["data"] or {})
            pinned_by = [x for x in (data.get("_pinned_by") or []) if x != identity]
            data["_pinned_by"] = pinned_by
            data.pop("_pinned", None)  # migrate legacy flag
...
_AI_WATCH_COMPANIES = {
    "foundation": [
        {"name": "OpenAI",             "tagline": "GPT-4, ChatGPT, Sora — the company that kicked off the AI era",      "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "openai.com"},
        {"name": "Anthropic",          "tagline": "Claude models — safety-first AI lab founded by ex-OpenAI team",      "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "anthropic.com"},
        {"name": "Google DeepMind",    "tagline": "Gemini, AlphaFold, AlphaGo — Google's combined AI research lab",    "country": "🇬🇧", "cc": "GB",    "stage": "Corporate",  "new": False, "website": "deepmind.google"},
        {"name": "Mistral AI",         "tagline": "Europe's leading open-weight model lab — fast and efficient",        "country": "🇫🇷", "cc": "EU",    "stage": "Scale-up",   "new": False, "website": "mistral.ai"},
        {"name": "Meta AI (FAIR)",     "tagline": "LLaMA open-source models powering thousands of AI products",         "country": "🇺🇸", "cc": "US",    "stage": "Corporate",  "new": False, "website": "ai.meta.com"},
        {"name": "xAI",                "tagline": "Musk's AI lab — Grok models, built on X/Twitter data",              "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "x.ai"},
        {"name": "DeepSeek",           "tagline": "Chinese open-source lab — R1 model matched GPT-4 at fraction of cost", "country": "🇨🇳", "cc": "OTHER", "stage": "Scale-up", "new": True,  "website": "deepseek.com"},
        {"name": "Aleph Alpha",        "tagline": "European sovereign AI — GDPR-first, Luminous models",               "country": "🇩🇪", "cc": "EU",    "stage": "Scale-up",   "new": True,  "website": "aleph-alpha.com"},
        {"name": "Cohere",             "tagline": "Enterprise LLM APIs — RAG, embeddings, Command R",                   "country": "🇨🇦", "cc": "OTHER", "stage": "Scale-up",   "new": False, "website": "cohere.com"},
        {"name": "Hugging Face",       "tagline": "The GitHub of ML — open-source models, datasets, spaces",           "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "huggingface.co"},
        {"name": "Stability AI",       "tagline": "Stable Diffusion — pioneering open-source image generation",        "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": False, "website": "stability.ai"},
        {"name": "Together AI",        "tagline": "Fast inference cloud for open-source models",                        "country": "🇺🇸", "cc": "US",    "stage": "Startup",    "new": False, "website": "together.ai"},
        {"name": "Perplexity AI",      "tagline": "AI-native search engine — answers with sources",                    "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "perplexity.ai"},
        {"name": "Groq",               "tagline": "Fastest LLM inference chip — LPU architecture, not GPU",            "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": True,  "website": "groq.com"},
    ],
    "agents": [
        {"name": "Cognition (Devin)",  "tagline": "Devin — the first AI software engineer, autonomous coding agent",   "country": "🇺🇸", "cc": "US",    "stage": "Startup",    "new": True,  "website": "cognition.ai"},
        {"name": "Adept AI",           "tagline": "AI agents that operate computers like a human — browser, apps",     "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "adept.ai"},
        {"name": "Clay",               "tagline": "AI-powered GTM data platform — agents for sales prospecting",       "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": True,  "website": "clay.com"},
        {"name": "11x",                "tagline": "AI SDR agents — Alice automates outbound sales at scale",           "country": "🇬🇧", "cc": "GB",    "stage": "Startup",    "new": True,  "website": "11x.ai"},
        {"name": "Ema",                "tagline": "Universal AI employee — multi-agent orchestration for enterprise",  "country": "🇺🇸", "cc": "US",    "stage": "Startup",    "new": True,  "website": "ema.co"},
        {"name": "Relevance AI",       "tagline": "No-code AI agent builder — hire AI workers for any role",          "country": "🇦🇺", "cc": "OTHER", "stage": "Startup",    "new": True,  "website": "relevanceai.com"},
        {"name": "Coframe",            "tagline": "AI that continuously A/B tests and rewrites your website copy",     "country": "🇺🇸", "cc": "US",    "stage": "Startup",    "new": True,  "website": "coframe.com"},
        {"name": "Lindy AI",           "tagline": "Personal AI assistant that takes actions across your tools",        "country": "🇺🇸", "cc": "US",    "stage": "Startup",    "new": True,  "website": "lindy.ai"},
        {"name": "MultiOn",            "tagline": "Web agents that browse and complete tasks autonomously",             "country": "🇺🇸", "cc": "US",    "stage": "Startup",    "new": True,  "website": "multion.ai"},
        {"name": "Artisan AI",         "tagline": "AI-powered sales platform — Ava automates entire SDR workflow",     "country": "🇺🇸", "cc": "US",    "stage": "Startup",    "new": True,  "website": "artisan.co"},
    ],
    "healthcare": [
        {"name": "Neko Health",        "tagline": "Full-body preventive health scans powered by AI",                   "country": "🇸🇪", "cc": "EU",    "stage": "Scale-up",   "new": True,  "website": "nekohealth.com"},
        {"name": "Hippocratic AI",     "tagline": "Safe AI healthcare agents for patient communication and care",      "country": "🇺🇸", "cc": "US",    "stage": "Startup",    "new": True,  "website": "hippocraticai.com"},
        {"name": "Suki AI",            "tagline": "Voice assistant for clinical documentation",                        "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "suki.ai"},
        {"name": "Viz.ai",             "tagline": "AI-powered stroke and cardiac care coordination",                   "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "viz.ai"},
        {"name": "BenevolentAI",       "tagline": "Drug discovery and development platform",                          "country": "🇬🇧", "cc": "GB",    "stage": "Listed",     "new": False, "website": "benevolent.ai"},
        {"name": "Recursion",          "tagline": "Drug discovery at machine scale",                                   "country": "🇺🇸", "cc": "US",    "stage": "Listed",     "new": False, "website": "recursion.com"},
        {"name": "Tempus AI",          "tagline": "AI data platform for precision oncology",                          "country": "🇺🇸", "cc": "US",    "stage": "Listed",     "new": True,  "website": "tempus.com"},
        {"name": "Nabla",              "tagline": "AI ambient scribe for doctors — automatic clinical notes",          "country": "🇫🇷", "cc": "EU",    "stage": "Scale-up",   "new": False, "website": "nabla.com"},
        {"name": "Paige.AI",           "tagline": "AI pathology — FDA-cleared cancer detection",                      "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "paige.ai"},
        {"name": "PathAI",             "tagline": "AI-powered pathology for drug development and diagnostics",         "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "pathai.com"},
        {"name": "Aidence",            "tagline": "AI lung cancer screening — CE-certified, EU-built",                "country": "🇳🇱", "cc": "EU",    "stage": "Scale-up",   "new": False, "website": "aidence.com"},
        {"name": "Insilico Medicine",  "tagline": "AI drug design — first AI-discovered drug in clinical trials",     "country": "🇭🇰", "cc": "OTHER", "stage": "Scale-up",   "new": False, "website": "insilico.com"},
    ],
    "fintech": [
        {"name": "Ramp",               "tagline": "AI-powered corporate cards and expense management",                 "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "ramp.com"},
        {"name": "Sardine",            "tagline": "AI fraud prevention for fintech and crypto",                       "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "sardine.ai"},
        {"name": "Cleo",               "tagline": "AI money coach — Gen Z banking alternative",                       "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": False, "website": "meetcleo.com"},
        {"name": "Quantexa",           "tagline": "AI for financial crime and customer intelligence",                 "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": False, "website": "quantexa.com"},
        {"name": "ComplyAdvantage",    "tagline": "AI financial crime risk data — AML screening and monitoring",      "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": True,  "website": "complyadvantage.com"},
        {"name": "Onfido",             "tagline": "AI identity verification — document and biometric checks",          "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": False, "website": "onfido.com"},
        {"name": "Feedzai",            "tagline": "Real-time AI fraud detection at banking scale",                    "country": "🇵🇹", "cc": "EU",    "stage": "Scale-up",   "new": False, "website": "feedzai.com"},
        {"name": "Taktile",            "tagline": "Decision automation for fintech risk teams",                       "country": "🇩🇪", "cc": "EU",    "stage": "Startup",    "new": False, "website": "taktile.com"},
        {"name": "Alloy",              "tagline": "Identity decisioning platform for banks and fintechs",             "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "alloy.com"},
        {"name": "Zest AI",            "tagline": "AI credit underwriting for inclusive lending",                     "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "zest.ai"},
        {"name": "Eigen Technologies", "tagline": "NLP for financial documents — contract and report data extraction", "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": False, "website": "eigentech.com"},
        {"name": "Monzo",              "tagline": "UK digital bank using AI for fraud and customer service",          "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": False, "website": "monzo.com"},
    ],
    "legal": [
        {"name": "Harvey",             "tagline": "AI for law firms — backed by OpenAI",                              "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": True,  "website": "harvey.ai"},
        {"name": "Robin AI",           "tagline": "AI contract review — backed by Linklaters, built for legal teams", "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": True,  "website": "robin.ai"},
        {"name": "Luminance",          "tagline": "AI contract analysis and due diligence",                           "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": False, "website": "luminance.com"},
        {"name": "Lexis+ AI",          "tagline": "LexisNexis AI assistant for legal research and drafting",          "country": "🇬🇧", "cc": "GB",    "stage": "Corporate",  "new": False, "website": "lexisnexis.com"},
        {"name": "Ironclad",           "tagline": "Digital contracting platform — contract lifecycle AI",             "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "ironcladapp.com"},
        {"name": "Clio",               "tagline": "Cloud legal practice management with AI workflows",                "country": "🇨🇦", "cc": "OTHER", "stage": "Scale-up",   "new": False, "website": "clio.com"},
        {"name": "Juro",               "tagline": "AI-native contract platform for in-house teams",                  "country": "🇬🇧", "cc": "GB",    "stage": "Startup",    "new": False, "website": "juro.com"},
        {"name": "Legl",               "tagline": "Client onboarding and compliance AI for UK law firms",            "country": "🇬🇧", "cc": "GB",    "stage": "Startup",    "new": False, "website": "legl.com"},
        {"name": "Legalfly",           "tagline": "AI legal assistant for European law — multilingual compliance",    "country": "🇧🇪", "cc": "EU",    "stage": "Startup",    "new": True,  "website": "legalfly.com"},
    ],
    "climate": [
        {"name": "Cervest",            "tagline": "Climate intelligence platform for physical risk",                  "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": False, "website": "cervest.earth"},
        {"name": "Pachama",            "tagline": "AI carbon credit verification via satellite",                      "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "pachama.com"},
        {"name": "Watershed",          "tagline": "Enterprise carbon management and reporting",                       "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "watershed.com"},
        {"name": "Persefoni",          "tagline": "Climate management and accounting — enterprise carbon disclosure",  "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": True,  "website": "persefoni.com"},
        {"name": "Tomorrow.io",        "tagline": "Weather and climate intelligence API",                             "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "tomorrow.io"},
        {"name": "Sylvera",            "tagline": "Carbon market ratings and analytics",                             "country": "🇬🇧", "cc": "GB",    "stage": "Startup",    "new": False, "website": "sylvera.com"},
        {"name": "South Pole",         "tagline": "Global climate solutions — carbon project developer",              "country": "🇨🇭", "cc": "EU",    "stage": "Scale-up",   "new": False, "website": "southpole.com"},
        {"name": "Climeworks",         "tagline": "Direct air capture — removing CO₂ from atmosphere at scale",      "country": "🇨🇭", "cc": "EU",    "stage": "Scale-up",   "new": False, "website": "climeworks.com"},
        {"name": "Deep Planet",        "tagline": "AI-powered precision agriculture — satellite crop monitoring",     "country": "🇬🇧", "cc": "GB",    "stage": "Startup",    "new": True,  "website": "deepplanet.ai"},
    ],
    "edtech": [
        {"name": "Khanmigo",           "tagline": "Khan Academy's AI tutor — Socratic, not answer-giving",           "country": "🇺🇸", "cc": "US",    "stage": "Non-profit", "new": False, "website": "khanmigo.ai"},
        {"name": "Synthesis",          "tagline": "AI-powered learning for kids — born at SpaceX",                   "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "synthesis.com"},
        {"name": "Sana Labs",          "tagline": "AI learning platform for enterprise teams",                       "country": "🇸🇪", "cc": "EU",    "stage": "Scale-up",   "new": False, "website": "sanalabs.com"},
        {"name": "Duolingo",           "tagline": "World's largest language learning app — AI-powered personalisation", "country": "🇺🇸", "cc": "US",  "stage": "Listed",     "new": False, "website": "duolingo.com"},
        {"name": "Multiverse",         "tagline": "AI-powered apprenticeships replacing traditional degrees",         "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": False, "website": "multiverse.io"},
        {"name": "Quizlet",            "tagline": "AI-powered study tools — flashcards, practice tests, Q-chat tutor", "country": "🇺🇸", "cc": "US",  "stage": "Scale-up",   "new": False, "website": "quizlet.com"},
        {"name": "Udemy",              "tagline": "Online marketplace with AI-curated learning paths for every role", "country": "🇺🇸", "cc": "US",    "stage": "Listed",     "new": False, "website": "udemy.com"},
        {"name": "Cognii",             "tagline": "AI writing assessment and virtual tutoring",                       "country": "🇺🇸", "cc": "US",    "stage": "Startup",    "new": False, "website": "cognii.com"},
        {"name": "Ello",               "tagline": "AI reading companion for children",                               "country": "🇺🇸", "cc": "US",    "stage": "Startup",    "new": False, "website": "ello.com"},
    ],
    "retail": [
        {"name": "Ocado Technology",   "tagline": "AI warehouse robotics and grocery fulfilment platform",           "country": "🇬🇧", "cc": "GB",    "stage": "Listed",     "new": False, "website": "ocadogroup.com"},
        {"name": "Bloomreach",         "tagline": "AI personalisation and search for e-commerce",                    "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "bloomreach.com"},
        {"name": "Signifyd",           "tagline": "AI fraud protection and chargeback insurance for retailers",      "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "signifyd.com"},
        {"name": "Constructor",        "tagline": "AI-powered product discovery — search and recommendations",       "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "constructor.com"},
        {"name": "Syte",               "tagline": "Visual AI for fashion — camera search and styling",               "country": "🇮🇱", "cc": "OTHER", "stage": "Scale-up",   "new": False, "website": "syte.ai"},
        {"name": "Focal Systems",      "tagline": "AI shelf analytics — detecting out-of-stocks in real time",      "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "focal.systems"},
        {"name": "Celonis",            "tagline": "Process mining AI — finding operational waste at enterprise scale", "country": "🇩🇪", "cc": "EU",  "stage": "Scale-up",   "new": False, "website": "celonis.com"},
        {"name": "Trigo",              "tagline": "AI checkout-free store technology for supermarkets",              "country": "🇮🇱", "cc": "OTHER", "stage": "Scale-up",   "new": False, "website": "trigoretail.com"},
        {"name": "Blue Yonder",        "tagline": "AI-driven supply chain and retail planning platform",             "country": "🇺🇸", "cc": "US",    "stage": "Corporate",  "new": False, "website": "blueyonder.com"},
        {"name": "Stitch Fix",         "tagline": "AI personal styling — algorithm-driven fashion recommendations",  "country": "🇺🇸", "cc": "US",    "stage": "Listed",     "new": False, "website": "stitchfix.com"},
    ],
    "hr": [
        {"name": "Beamery",            "tagline": "AI talent intelligence — skills-based hiring and retention",      "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": False, "website": "beamery.com"},
        {"name": "Eightfold AI",       "tagline": "AI talent platform — matching people to roles they can grow into", "country": "🇺🇸", "cc": "US",   "stage": "Scale-up",   "new": False, "website": "eightfold.ai"},
        {"name": "HireVue",            "tagline": "AI video interview and assessments for high-volume hiring",       "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "hirevue.com"},
        {"name": "Paradox",            "tagline": "Olivia — AI recruiting assistant that handles scheduling",        "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "paradox.ai"},
        {"name": "Textio",             "tagline": "AI writing for inclusive job posts and performance reviews",      "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "textio.com"},
        {"name": "Phenom",             "tagline": "AI talent experience platform — career sites and CRM",           "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "phenom.com"},
        {"name": "Leapsome",           "tagline": "AI people enablement — performance, learning, engagement",       "country": "🇩🇪", "cc": "EU",    "stage": "Scale-up",   "new": False, "website": "leapsome.com"},
        {"name": "SeekOut",            "tagline": "AI talent search — finds passive candidates across the web",     "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": True,  "website": "seekout.com"},
        {"name": "Maki People",        "tagline": "AI hiring assessments — culture and skills fit at scale",        "country": "🇫🇷", "cc": "EU",    "stage": "Startup",    "new": True,  "website": "maki.io"},
        {"name": "Bryq",               "tagline": "Talent intelligence using cognitive and personality science",    "country": "🇬🇷", "cc": "EU",    "stage": "Startup",    "new": False, "website": "bryq.com"},
    ],
    "security": [
        {"name": "Darktrace",          "tagline": "Autonomous AI cyber defence — self-learning threat detection",   "country": "🇬🇧", "cc": "GB",    "stage": "Listed",     "new": False, "website": "darktrace.com"},
        {"name": "Wiz",                "tagline": "Cloud security posture — acquired by Google for $32bn",          "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": True,  "website": "wiz.io"},
        {"name": "SentinelOne",        "tagline": "AI endpoint security — real-time threat prevention",             "country": "🇺🇸", "cc": "US",    "stage": "Listed",     "new": False, "website": "sentinelone.com"},
        {"name": "Abnormal Security",  "tagline": "AI email security — stops social engineering and BEC",          "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "abnormalsecurity.com"},
        {"name": "Recorded Future",    "tagline": "AI-powered threat intelligence — real-time adversary tracking", "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": True,  "website": "recordedfuture.com"},
        {"name": "Vectra AI",          "tagline": "AI-powered network detection and response",                      "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "vectra.ai"},
        {"name": "Orca Security",      "tagline": "AI cloud security — agentless workload and data protection",    "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "orca.security"},
        {"name": "Snyk",               "tagline": "Developer-first AI security — finds vulns in code and deps",    "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": False, "website": "snyk.io"},
        {"name": "Exabeam",            "tagline": "AI SIEM — behavioural analytics for threat detection",          "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "exabeam.com"},
        {"name": "Panther",            "tagline": "Cloud-native SIEM — AI-powered threat detection for devops teams", "country": "🇺🇸", "cc": "US",  "stage": "Startup",    "new": True,  "website": "panther.com"},
    ],
    "creative": [
        {"name": "Midjourney",         "tagline": "The leading AI image generation model — photorealistic and artistic", "country": "🇺🇸", "cc": "US", "stage": "Startup",  "new": False, "website": "midjourney.com"},
        {"name": "ElevenLabs",         "tagline": "AI voice — cloning, dubbing, and text-to-speech at scale",       "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "elevenlabs.io"},
        {"name": "Suno",               "tagline": "AI music generation — full songs with vocals in seconds",         "country": "🇺🇸", "cc": "US",    "stage": "Startup",    "new": True,  "website": "suno.com"},
        {"name": "Udio",               "tagline": "AI music creation — studio-quality tracks from a text prompt",   "country": "🇺🇸", "cc": "US",    "stage": "Startup",    "new": True,  "website": "udio.com"},
        {"name": "Runway",             "tagline": "AI video generation and creative tools — Gen-2 and beyond",      "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "runwayml.com"},
        {"name": "Synthesia",          "tagline": "AI video with digital avatars — enterprise L&D and comms",      "country": "🇬🇧", "cc": "GB",    "stage": "Scale-up",   "new": False, "website": "synthesia.io"},
        {"name": "HeyGen",             "tagline": "AI video translation and personalised spokesperson videos",      "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "heygen.com"},
        {"name": "Descript",           "tagline": "AI podcast and video editor — edit audio by editing text",      "country": "🇺🇸", "cc": "US",    "stage": "Scale-up",   "new": False, "website": "descript.com"},
        {"name": "Pika Labs",          "tagline": "AI video generation — fast, accessible, consumer-focused",      "country": "🇺🇸", "cc": "US",    "stage": "Startup",    "new": False, "website": "pika.art"},
        {"name": "Ideogram",           "tagline": "AI image generation with accurate text rendering",               "country": "🇨🇦", "cc": "OTHER", "stage": "Startup",    "new": False, "website": "ideogram.ai"},
        {"name": "Adobe Firefly",      "tagline": "Adobe's generative AI — commercially safe images inside Creative Cloud", "country": "🇺🇸", "cc": "US", "stage": "Corporate", "new": False, "website": "firefly.adobe.com"},
    ],
}

@app.route("/api/intel/verticals")
def api_intel_verticals():
    vertical = request.args.get("v", "foundation").lower().strip()
    country  = request.args.get("country", "").upper().strip()   # GB | US | EU | "" = all
    companies = _AI_WATCH_COMPANIES.get(vertical, [])
    if country:
        companies = [c for c in companies if c.get("cc", "") == country]
    return jsonify({
        "vertical":  vertical,
        "companies": companies,
...
_HELP_MSG = (
    ...
    "  _pizza GU25_  |  _cocktails KT15_  |  _pub KT15_\n"
    "  _breakfast KT16_  |  _good lunch near me_\n"
    "  _(set home postcode on miru.humanagency.co to skip the postcode)_\n"
    "\n"
    "🍷 *Wine*\n"
    "  _rate this wine_  |  _Malbec under £10_  |  _wine Whispering Angel_\n"
    "\n"
    "🚆🚇 *Trains & Tube*\n"
    "  _train waterloo to lewisham_  |  _trains from Blackfriars_\n"
    "  _tube status_  |  _jubilee line_  |  _elizabeth line_\n"
    ...
    "  _who is my MP KT16_  |  _my MP KT15_\n"
    "  _my councillor KT16_  |  _who is my councillor GU25_\n"
    "\n"
    "🏫 *School comms*\n"
    ...
    "\n"
    "🔍 *Brand intel*\n"
    "  brand Unilever  |  brand Tesco\n"
    "  _(or send a photo of a product/logo — I'll identify the brand)_\n"
    "\n"
    "🎵 *Music*\n"
    "  song Africa by Toto  |  my songs\n"
    "\n"
    "🛒 *Price check*\n"
    "  price olive oil  |  compare oat milk\n"
    "\n"
    "🧾 *Receipts & spending*\n"
    "  Send a photo of any receipt — I'll log it\n"
    "  _how much did I spend this month?_  |  _Tesco spend this week?_\n"
    "\n"
    "📸 *Photo*  — send any photo to identify, describe, or scan\n"
    "📍 *Live location*  — share your location for food/places nearby\n"
    "\n"
...
def whatsapp_reply():
    ...
    # ── BOOK NATURAL LANGUAGE — fuzzy intent via Groq ────────────────────────
    # Catches any book-related phrasing not already handled by exact commands above
    _BOOK_NL_RE = re.compile(
        r'\b(?:book|read|reading|review|library|finished|author|novel|isbn|'
        r'worth\s+reading|have\s+i\s+read|did\s+i\s+read|do\s+i\s+have|'
        r'want\s+to\s+read|currently\s+reading|started\s+reading|'
        r'completed|done\s+reading|surrey|chapters?)\b', re.I
    )
    if _BOOK_NL_RE.search(body) and not _bk_prefix and body_lower not in _MY_BOOKS_TRIGGERS \
            and not body_lower.startswith("my books") and not body_lower.startswith("books i ") \
            and cmd_up not in ("WORTH IT", "WORTH IT?", "REVIEWS", "BOOK REVIEW", "THOUGHTS"):
        try:
            _nl_raw = _groq_chat(
                system=(
                    'Extract the book intent from this WhatsApp message. '
                    'Respond with JSON only:\n'
                    '{"intent":"check_read|review|mark_read|mark_reading|mark_wishlist|library_check|add|unknown",'
                    '"title":"book title extracted, or empty string"}\n\n'
                    'Intents:\n'
                    '- check_read: asking if they have read or own a book ("do i have", "have i read", "did i read")\n'
                    '- review: wants a review or opinion ("book review", "reviews", "is it worth reading", "thoughts on")\n'
                    '- mark_read: finished or completed a book ("finished", "done reading", "completed")\n'
                    '- mark_reading: currently reading ("reading", "started reading", "currently reading")\n'
                    '- mark_wishlist: wants to read ("want to read", "want")\n'
                    '- library_check: checking local library availability ("library", "surrey library", "available at library")\n'
                    '- add: adding/saving a book ("add book", "save book")\n'
                    '- unknown: not a book request'
                ),
                messages=[{"role": "user", "content": body}],
                max_tokens=80,
                json_mode=True,
            )
            _nl = json.loads(_nl_raw) if isinstance(_nl_raw, str) else (_nl_raw or {})
            _nl_intent = (_nl.get("intent") or "unknown").strip()
            _nl_title  = (_nl.get("title") or "").strip()
        except Exception:
            _nl_intent, _nl_title = "unknown", ""

        if _nl_intent != "unknown" and _nl_title:
            plain_number = from_number.replace("whatsapp:", "").strip()
            wa_number    = f"whatsapp:{plain_number}"

            if _nl_intent == "check_read":
                hits = lib.books_search(plain_number, _nl_title, hits_per_page=5)
                if not hits: hits = lib.books_search(wa_number, _nl_title, hits_per_page=5)
                if hits:
                    b = hits[0]
                    status_label = {"read": "✅ Yes, you've read it", "reading": "📖 You're currently reading it",
                                    "wishlist": "📌 On your want-to-read list"}.get(b.get("status",""), "📚 In your library")
                    msg = f"{status_label}\n\n*{b.get('title','')}*"
                    ...
                    try:
                        rows = (lib._sb().table("wa_saves")
                                ...
                                .in_("from_number", [from_number, plain_number, wa_number])
                                .like("url", "book:%").ilike("title", f"%{_nl_title}%")
                    ...
                    if rows:
                        ...
                        msg = f"📚 I don't have *{_nl_title}* in your library.\n\nSend *book {_nl_title}* to add it."
                resp.message(msg)
                return str(resp)

            elif _nl_intent == "review":
                bk = _lookup_book_by_title(_nl_title)
                if not bk or not bk.get("title"):
                    resp.message(f"📚 Couldn't find *{_nl_title}* — try the exact title.")
                    return str(resp)
                book_label = f"*{bk['title']}*" + (f" by {bk['author']}" if bk.get("author") else "")
                ctx = [f"Title: {bk['title']}"]
                if bk.get("author"):      ctx.append(f"Author: {bk['author']}")
                if bk.get("subjects"):    ctx.append(f"Genre: {bk['subjects']}")
                if bk.get("description"): ctx.append(f"Description: {bk['description'][:500]}")
                cr = bk.get("communityRating") or {}
                if cr.get("avg"):         ctx.append(f"Google Books rating: {cr['avg']}/5")
                try:
                    verdict = _groq_chat(
                        system=(
                            "You are a concise book critic. Using ONLY the provided information, write exactly 4 lines:\n"
            ...
            elif _nl_intent in ("mark_read", "mark_reading", "mark_wishlist"):
                new_status  = {"mark_read": "read", "mark_reading": "reading", "mark_wishlist": "wishlist"}[_nl_intent]
                ...
                try:
                    ...
                    rows = []
                if not rows:
                    bk_info = _lookup_book_by_title(_nl_title)
                    if not bk_info or not bk_info.get("title"):
                        resp.message(f"📚 Couldn't find *{_nl_title}*. Try *book {_nl_title}* to add it first.")
                        return str(resp)
                    bk_isbn = bk_info.get("isbn", "")
                    try:
                        lib._sb().table("wa_saves").insert({
                            "from_number": plain_number, "url": f"book:{bk_isbn}",
                            "title": bk_info["title"], "summary": json.dumps(bk_info), "status": new_status,
                        }).execute()
                ...
                try:
                    ...
                    pass
                title_clean = (row.get("title") or _nl_title).replace("📚 ", "")
                ...
                bk_info = _lookup_book_by_title(_nl_title)
                if not bk_info or not bk_info.get("title"):
                    resp.message(f"📚 Couldn't find *{_nl_title}* — try a more specific title.")
                    return str(resp)
                bk_isbn = bk_info.get("isbn", "")
                try:
                    existing = (lib._sb().table("wa_saves").select("id")
                ...
                msg += "\n\n_(already in your books)_" if already else f"\n\n📚 Saved: miru.humanagency.co/?screen=scan&token={user_token}"
                resp.message(msg)
                return str(resp)
