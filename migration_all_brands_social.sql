-- Complete Social Media Data for All 85 Intel Brands
-- Includes original 25 + 60 new brands across all categories
...
-- ORIGINAL SKINCARE BRANDS
('Himalaya', 'Instagram', '8.2M', '35M+', '$450K', 3.4, 8.6),
('Himalaya', 'TikTok', '4.1M', '18M+', '$250K', 5.8, 8.5),
('Himalaya', 'YouTube', '1.8M', '12M+', '$150K', 2.2, 8.0),
...
('Neutrogena', 'YouTube', '1.4M', '10M+', '$180K', 1.8, 7.5),

('Clinique', 'Instagram', '4.2M', '18M+', '$700K', 2.8, 8.7),
('Clinique', 'YouTube', '890K', '12M+', '$300K', 2.1, 8.2),
('Clinique', 'TikTok', '1.1M', '6M+', '$200K', 4.0, 8.0),

('Estée Lauder', 'Instagram', '6.1M', '25M+', '$900K', 2.5, 8.9),
('Estée Lauder', 'YouTube', '1.2M', '15M+', '$400K', 1.8, 8.4),
('Estée Lauder', 'TikTok', '1.8M', '8M+', '$350K', 3.8, 8.5),

('Vichy', 'Instagram', '3.1M', '12M+', '$300K', 2.1, 8.0),
('Vichy', 'YouTube', '680K', '8M+', '$150K', 1.6, 7.6),

('Lotus Herbals', 'Instagram', '2.4M', '10M+', '$200K', 3.6, 8.1),
('Lotus Herbals', 'TikTok', '1.9M', '8M+', '$150K', 5.2, 8.3),

('Pond''s', 'Instagram', '5.2M', '18M+', '$350K', 2.2, 8.1),
('Pond''s', 'YouTube', '1.1M', '12M+', '$200K', 1.5, 7.7),
('Pond''s', 'TikTok', '1.8M', '7M+', '$180K', 4.1, 8.0),

('Shiseido', 'Instagram', '3.9M', '15M+', '$500K', 2.7, 8.5),
('Shiseido', 'YouTube', '820K', '10M+', '$250K', 2.0, 8.1),

('L''Oréal', 'Instagram', '14.2M', '60M+', '$1.2M', 2.2, 9.0),
('L''Oréal', 'YouTube', '3.5M', '40M+', '$600K', 1.4, 8.8),
('L''Oréal', 'TikTok', '5.1M', '25M+', '$500K', 4.5, 8.7),

-- ORIGINAL BEVERAGE BRANDS
('Pepsi', 'Instagram', '14.1M', '65M+', '$1.8M', 2.3, 9.0),
('Pepsi', 'TikTok', '8.7M', '45M+', '$1.2M', 4.8, 8.9),
('Pepsi', 'YouTube', '6.2M', '55M+', '$800K', 1.7, 8.6),
('Pepsi', 'Twitter', '3.2M', '15M+', '$250K', 0.9, 8.0),

('Sprite', 'Instagram', '9.3M', '40M+', '$900K', 2.6, 8.6),
('Sprite', 'TikTok', '6.1M', '28M+', '$700K', 4.9, 8.5),
('Sprite', 'YouTube', '4.2M', '35M+', '$500K', 1.5, 8.2),
...
('Fanta', 'Instagram', '6.8M', '28M+', '$550K', 2.8, 8.4),
('Fanta', 'TikTok', '5.1M', '22M+', '$450K', 5.3, 8.6),
('Fanta', 'YouTube', '3.2M', '20M+', '$350K', 1.6, 8.1),

('Tropicana', 'Instagram', '4.1M', '16M+', '$400K', 2.1, 8.0),
('Tropicana', 'YouTube', '1.8M', '14M+', '$250K', 1.5, 7.7),

('Gatorade', 'Instagram', '5.9M', '24M+', '$500K', 2.9, 8.3),
('Gatorade', 'TikTok', '3.8M', '16M+', '$350K', 4.6, 8.2),
('Gatorade', 'YouTube', '2.4M', '18M+', '$300K', 2.1, 8.0),
...
('Lipton', 'Instagram', '2.8M', '11M+', '$250K', 1.9, 7.8),
('Lipton', 'YouTube', '1.1M', '8M+', '$150K', 1.3, 7.4),

('Minute Maid', 'Instagram', '3.2M', '13M+', '$300K', 2.0, 7.9),
('Minute Maid', 'YouTube', '1.4M', '10M+', '$200K', 1.5, 7.6),

('Nescafé', 'Instagram', '4.6M', '18M+', '$400K', 2.3, 8.1),
('Nescafé', 'TikTok', '2.1M', '9M+', '$250K', 4.2, 8.0),

-- ORIGINAL SNACK BRANDS (None - only had QSR/beverages)
...
('Doritos', 'YouTube', '4.1M', '30M+', '$500K', 1.8, 8.2),

('Cheetos', 'Instagram', '7.3M', '32M+', '$600K', 2.9, 8.4),
('Cheetos', 'TikTok', '5.8M', '26M+', '$500K', 5.1, 8.5),

('Pringles', 'Instagram', '6.8M', '30M+', '$600K', 2.6, 8.4),
('Pringles', 'TikTok', '5.1M', '22M+', '$450K', 4.9, 8.5),
('Pringles', 'YouTube', '2.3M', '16M+', '$300K', 1.7, 8.0),

('Oreo', 'Instagram', '9.1M', '40M+', '$800K', 3.2, 8.7),
('Oreo', 'TikTok', '8.9M', '38M+', '$750K', 6.2, 8.9),
('Oreo', 'YouTube', '3.4M', '28M+', '$400K', 2.2, 8.3),
...
('Subway', 'YouTube', '2.6M', '18M+', '$350K', 1.9, 7.8),
...
('Pizza Hut', 'TikTok', '3.1M', '14M+', '$350K', 4.2, 8.1)
